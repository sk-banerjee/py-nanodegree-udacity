...
test_image1="pet_images/Dalmatian_04017.jpg"
...
image_classification1 = classifier(test_image1, model)
...
print("\nResults from test_classifier.py\nImage:", test_image1, "using model:",
      model, "was classified as a:", image_classification1, "type:", type(image_classification1))
